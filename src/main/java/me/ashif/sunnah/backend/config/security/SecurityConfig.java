...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		login = login.loginPage(Constants.LOGIN_URL).loginProcessingUrl(Constants.LOGIN_PROCESSING_URL)
				.failureUrl(Constants.LOGIN_FAILURE_URL).successHandler(successHandler);
		login.and().logout().logoutSuccessUrl(Constants.LOGOUT_URL);
	}
